...
KBUILD_AFLAGS += -O3 -funroll-loops
endif

KBUILD_CFLAGS += -mcpu=cortex-a55+crc+crypto -mtune=cortex-a55 -march=armv8.2-a+crc+crypto+lse
KBUILD_AFLAGS += -mcpu=cortex-a55+crc+crypto -mtune=cortex-a55 -march=armv8.2-a+crc+crypto+lse
